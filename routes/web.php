...
//    teacher routes
    ...
    Route::middleware('is_teacher')->post('/new-profile', [TeacherController::class, 'newProfile'])->name('new-profile');
...
//    student module
    ...
    Route::middleware('is_admin')->get('/manage-subject', [SubjectController::class, 'manageSubject'])->name('manage-subject');
    Route::middleware('is_admin')->get('/edit-subject/{id}', [SubjectController::class, 'editSubject'])->name('edit-subject');
    Route::middleware('is_admin')->post('/update-subject/{id}', [SubjectController::class, 'updateSubject'])->name('update-subject');
